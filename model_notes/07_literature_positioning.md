...
This module records how the paper should be positioned after the third-round
critique and the external notes on macro-JMP positioning. It is a positioning
...
quantitative industrial policy paper about the dynamic welfare effect of
decentralized expansionary local industrial policy over the endogenous industry
life cycle of a strategic emerging industry. It asks when local competition is
discovery and creative destruction, and when it becomes duplicated capacity and
aggregate misallocation. It is not a pure
...
predefined stages. It should describe the path generated by policy, entry,
capacity investment, demand absorption, price adjustment, utilization, profits,
and capital returns.
...
return to the same decentralized local implementation changes as capacity,
demand absorption, prices, utilization, profits, and MPK gaps evolve. The key
